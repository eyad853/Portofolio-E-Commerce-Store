...
return (
    <div className='w-full min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex justify-center items-center p-2 sm:p-4'>
        <div className='bg-white shadow-2xl rounded-2xl overflow-hidden w-full max-w-5xl flex flex-col lg:flex-row lg:min-h-[600px]'>
            ...
            <div className='w-full lg:w-1/2 h-48 sm:h-64 lg:h-auto lg:flex-1 bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 relative overflow-hidden lg:flex-shrink-0'>
                <div className='absolute inset-0 bg-black/20'></div>
                <div className='relative z-10 h-full flex flex-col justify-center items-center text-white p-4 sm:p-8'>
                    <div className='text-center mb-4 sm:mb-8'>
                        <h1 className='text-xl sm:text-2xl lg:text-4xl font-bold mb-2 sm:mb-4'>Join Our Store</h1>
                        <p className='text-sm sm:text-base lg:text-lg opacity-90'>Discover amazing products and start shopping today</p>
                    </div>
            ...
            <div className='w-full lg:w-1/2 flex flex-col justify-center p-4 sm:p-6 lg:p-8 lg:h-full'>
                ...
                <div className='text-center mb-3 lg:mb-4'>
                    ...
                    <p className='text-sm sm:text-base lg:text-sm text-gray-600'>Sign up to start your shopping journey</p>
                </div>
                ...
                <form onSubmit={handleNormalSignup} encType="multipart/form-data" className='flex-1 space-y-2 lg:space-y-3'>
                    ...
                    {/* Name Input */}
                    <div>
                        <label className='block text-xs sm:text-sm lg:text-xs font-semibold text-gray-700 mb-1'>Full Name</label>
                    ...
                    <div className='space-y-2 pt-2 lg:pt-3'>
                        <button
                            type='submit'
                            disabled={loadings}
                            className='w-full py-2 lg:py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold rounded-lg transform transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:transform-none text-sm'
                        >
                        ...
                        <button 
                            type="button"
                            onClick={handleTryAsAdmin}
                            disabled={loadings}
                            className='w-full py-2 lg:py-2.5 border-2 border-purple-500 text-purple-600 font-semibold rounded-lg transform hover:scale-105 transition-all duration-300 hover:bg-purple-50 disabled:opacity-50 disabled:transform-none text-sm'
                        >
                            Try as Admin
                        </button>
                    </div>
