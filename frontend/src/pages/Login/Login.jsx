...
import { FaGoogle, FaGithub, FaUser } from "react-icons/fa"; // Removed FaUser, LuUserPlus as they aren't used in login form
...
const Login = ({setTrigger}) => {
    ...
    return (
        <div className='w-screen bg-gradient-to-br from-blue-50 to-purple-50 flex justify-center items-center p-2 sm:p-4'>
                <div className='bg-white shadow-2xl rounded-2xl overflow-hidden w-full max-w-5xl flex flex-col lg:flex-row lg:min-h-[400px]'>
                    ...
                    <div className='w-full lg:w-1/2 flex flex-col justify-center p-4 sm:p-6 lg:p-8 lg:h-full'>
                        ...
                        <div className='text-center mb-3 lg:mb-4'>
                            <h2 className='text-xl sm:text-2xl lg:text-2xl font-bold text-gray-800 mb-1 lg:mb-2'>Log In Your Account</h2>
                            <p className='text-sm sm:text-base lg:text-sm text-gray-600'>Login and start your shopping journey</p>
                        </div>
